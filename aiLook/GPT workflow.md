<!-- MOVED: This GPT Workflow was originally created at the repository root as `GPT workflow.md`. It has been moved to `aiLook/GPT workflow.md`, which is the intended AI workflow location. -->
